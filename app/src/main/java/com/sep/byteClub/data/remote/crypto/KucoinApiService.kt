package com.sep.byteClub.data.remote.crypto

import com.sep.byteClub.data.model.response.crypto.AccountResponse
import com.sep.byteClub.data.model.response.crypto.AccountSummeryResponse
import com.sep.byteClub.data.model.response.crypto.AllTickersResponse
import com.sep.byteClub.data.model.response.crypto.CryptoBaseResponse
import com.sep.byteClub.data.model.response.crypto.CurrencyResponse
import com.sep.byteClub.data.model.response.crypto.PriceResponse
import com.sep.byteClub.data.model.response.crypto.SingleTickerResponse
import com.sep.byteClub.data.model.response.crypto.Ticker24hResponse
